                            ...
                            {[
                                ...
                                <div key={key} className="bg-[#111111] p-4 rounded-xl border border-[#2e2e2e]">
                                    <div className="flex items-center justify-between gap-4">
                                        ...
                                        <button onClick={() => void copyValue(value, key)} className="p-2 bg-[#1a1a1a] rounded-lg border border-[#2e2e2e] hover:border-primary/50 transition-all text-zinc-400 hover:text-white shrink-0">
                                        ...
                                        {[
                                            ...
                                            <tr key={label} className="hover:bg-zinc-900/30">
                                                ...
                                                <td className="px-4 py-3 text-right">
                                                    <button onClick={() => void copyValue(value, label)} className="p-1 text-zinc-600 hover:text-white">
                        ...
                        <div className="space-y-6">
                            <div className="bg-[#111111] p-4 rounded-xl border border-[#2e2e2e]">
                                <div className="flex items-center justify-between gap-4">
                                    ...
                                    <button onClick={() => void copyValue(connection?.api_url || '', 'api-url')} className="p-2 bg-[#1a1a1a] rounded-lg border border-[#2e2e2e] hover:border-primary/50 transition-all text-zinc-400 hover:text-white shrink-0">
                            ...
                            <div className="bg-[#111111] p-4 rounded-xl border border-[#2e2e2e]">
                                <div className="flex items-center justify-between gap-4">
                                    ...
                                    <button onClick={() => void copyValue(localStorage.getItem('ozy_token') || '', 'session-token')} className="p-2 bg-[#1a1a1a] rounded-lg border border-[#2e2e2e] hover:border-primary/50 transition-all text-zinc-400 hover:text-white shrink-0">
