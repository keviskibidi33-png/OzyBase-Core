...
const ConnectionModal = ({ isOpen, onClose }) => {
    ...
    const [frameworkType, setFrameworkType] = useState('nextjs');
    const [mobileType, setMobileType] = useState('flutter');
    ...
    const renderCodeCard = (title, snippet, copyKey) => (
                            ...
                            {activeTab === 'frameworks' && (
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <select value={frameworkType} onChange={(e) => setFrameworkType(e.target.value)} className="bg-[#111111] border border-[#2e2e2e] rounded-lg px-3 py-1.5 text-xs text-zinc-300">
                            ...
                            {activeTab === 'mobile' && (
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <select value={mobileType} onChange={(e) => setMobileType(e.target.value)} className="bg-[#111111] border border-[#2e2e2e] rounded-lg px-3 py-1.5 text-xs text-zinc-300">
                            ...
                            {activeTab === 'orms' && (
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <select value={ormType} onChange={(e) => setOrmType(e.target.value)} className="bg-[#111111] border border-[#2e2e2e] rounded-lg px-3 py-1.5 text-xs text-zinc-300">
